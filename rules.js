...
window.SEA_RULES = {
  ...
  vessels: [
...

    {
      ...
      note: "כלי שיט <7 מ׳ בעוגן מחוץ לנתיב/מעגן — פטור מפנס וכדור עוגן. עוסק בדיג בעוגן מציג אורות דיג, לא אורות עוגן.",
      summary: "בעוגן (מתחת ל‑50 מ׳): פנס מעגלי לבן אחד במקום הנראה ביותר. ביום — כדור שחור אחד בחרטום.",
      examTip: "כדור שחור בודד בחרטום = כלי שיט בעוגן."
    },

    {
      id: "anchor_50",
      name: "כלי שיט בעוגן, באורך 50 מטר ומעלה",
      shortName: "בעוגן ≥ 50 מ׳",
      ref: { colreg: "Rule 30(a)", israeli: "" },
      giveWayClass: "anchor",
      underway: false,
      lights: [
        { place: "anchor",     color: "white", arc: 360, label: "פנס עוגן קדמי (גבוה)", desc: "פנס מעגלי לבן בחלק הקדמי — הגבוה מבין השניים." },
        { place: "anchor-aft", color: "white", arc: 360, label: "פנס עוגן אחורי (נמוך)", desc: "פנס מעגלי לבן בירכתיים או קרוב להן — נמוך מהקדמי. שימו לב: הפוך מפנסי התורן של ממונע גדול (שם האחורי גבוה)!" }
      ],
      shapes: [
        { shape: "ball", place: "fwd", color: "black", label: "כדור שחור", desc: "ביום: כדור שחור אחד בחלק הקדמי." }
      ],
      note: "כלי שיט באורך 100 מ׳ ומעלה בעוגן חייב להאיר את סיפוניו גם בתאורת עבודה (תקנה 30(ג)).",
      summary: "בעוגן ≥50 מ׳: שני פנסי עוגן מעגליים לבנים — קדמי גבוה ואחורי נמוך. ≥100 מ׳ — גם תאורת סיפונים. ביום — כדור שחור אחד.",
      examTip: "שני לבנים מעגליים, הקדמי גבוה מהאחורי = עוגן גדול. אצל ממונע ≥50 מ׳ בהפלגה זה הפוך — האחורי גבוה."
    },
...

    {
      ...
      lights: [
        { place: "torch", color: "white", arc: 360, optional: true, label: "פנס יד / לפיד לבן", desc: "אינו פנס קבוע: מוחזק ביד ומוצג בעוד מועד כדי למנוע התנגשות (תקנה 25(ד))." }
      ],
      shapes: [],
